...
<div class="row">
  ...
  <div class="col-md-6">
  {{link_to('admin/news', "Go Back" , $attributes = array('class'=>'btn yellow pull-right')) }}
	</div>
</div>
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				{{ Form::open(array('url' => 'admin/news/update/'.$news->id,'role' => 'form','method'=>'PUT')) }}
				<div class="form-body">
					<div class="row">
						<div class="form-group col-md-6">
							<label>Sport</label>
							{{Form::select('sport_id', $sports , $news->sport_id,["class"=>"form-control","onchange"=>"get_option_sport('category_id','sport_id',0,1)"])}}
							<span class="parsley-error-list"><?php echo $errors->first('sport_id'); ?></span>
						</div>
						<div class="form-group col-md-6">
							<label>Category</label>
							{{Form::select('category_id',$category_list,$news->category_id,["class"=>"form-control", "placeholder"=>"e.g. Football League"])}}
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label>Feed</label>
							{{Form::text('rss_feed',$news->rss_feed,["class"=>"form-control"])}}
